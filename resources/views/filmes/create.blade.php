              ...
              <div class="form d-flex align-items-center">
                ...
                {{ csrf_field() }}
                    <div class="form-group">
                      <input id="login-username" type="text" name="nomeFilme" required data-msg="Informe seu nome" class="input-material">
                      <label for="login-username" class="label-material">Nome</label>
                    </div>
                    <div class="form-group">
                      <input id="login-email" type="text" name="duracaoFilme"  data-msg="Informe seu e-mail" class="input-material">
                      <label for="login-email" class="label-material">Duração</label>
                    </div>
                    <div class="form-group">
                      <input id="login-email" type="text" name="descricaoFilme"  data-msg="Informe seu e-mail" class="input-material">
                      <label for="login-email" class="label-material">Descrição</label>
                    </div>
                    <div class="form-group">
                      <input id="login-email" type="text" name="avaliacaoFilme"  data-msg="Informe seu e-mail" class="input-material">
                      <label for="login-email" class="label-material">Avaliação</label>
                    </div>
                    <div class="form-group">
                      <input id="login-email" type="text" name="statusFilme"  data-msg="Informe seu e-mail" class="input-material">
