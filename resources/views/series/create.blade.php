              ...
              <div class="form d-flex align-items-center">
                ...
                {{ csrf_field() }}
                    <div class="form-group">
                      <input id="login-username" type="text" name="nomeSerie" required data-msg="Informe seu nome" class="input-material">
                      <label for="login-username" class="label-material">Nome</label>
                    </div>
                    <div class="form-group">
                      <input id="login-email" type="text" name="descSerie"  data-msg="Informe seu e-mail" class="input-material">
                      <label for="login-email" class="label-material">Descrição</label>
                    </div>
                    <div class="form-group">
                      <input id="login-email" type="text" name="statusSerie"  data-msg="Informe seu e-mail" class="input-material">
                      <label for="login-email" class="label-material">Status</label>
                    </div>
                    <div class="form-group">
                      <input id="login-email" type="text" name="avaliacaoSerie"  data-msg="Informe seu e-mail" class="input-material">
