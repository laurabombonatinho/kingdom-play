...
<h3 class="title"><i class="icon-light-bulb"></i> Sugestões </h3>
  ...
  <div class="col-sm-4">
  <div class="card" style="width:300px">
    <img class="card-img-top" src="img/inocentes.jpg" alt="Card image" style="width:100%">
    <div class="card-body">
 ...
 <div class="col-sm-4">
  <div class="card" style="width:300px">
    <img class="card-img-top" src="img/grace.jpg" alt="Card image" style="width:100%">
    <div class="card-body">
...
<h3 class="title"><i class="fas fa-fire"></i> Novidades </h3>
...
<div class="col-sm-4">
<div class="card" style="width:300px">
  <img class="card-img-top" src="img/goodDoctor.jpg" alt="Card image" style="width:100%">
  <div class="card-body">
...
<div class="col-sm-4">
<div class="card" style="width:300px">
  <img class="card-img-top" src="img/jack.jpg" alt="Card image" style="width:100%">
  <div class="card-body">
...
<div class="col-sm-4">
<div class="card" style="width:300px">
  <img class="card-img-top" src="img/venom.jpg" alt="Card image" style="width:100%">
  <div class="card-body">
